...
export default function WebsiteKapper() {
  return (
    <div style={{ fontFamily: "Inter, sans-serif", padding: "40px 20px", maxWidth: 900, margin: "0 auto" }}>
      <NavBar />
      ...
      <p>
        ...
        Steeds meer mensen zoeken online naar een kapper in de buurt. Zonder goede website mis je dagelijks potentiële klanten.
      </p>
      ...
      <p>
        Wij maken websites speciaal voor kappers en barbershops. Alles is gericht op meer klanten.
      </p>
      ...
      <h2>Binnen 48 uur online</h2>
      <p>
        Wij regelen alles voor je: design, hosting, domein en onderhoud.
        Jij hoeft alleen je wensen door te geven.
      </p>
      ...
      <p>
        Wil jij ook meer afspraken via je website? Neem contact met ons op en ontvang een gratis analyse.
      </p>
