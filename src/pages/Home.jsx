            ...
            <div className="hero-mockup-wrap">
              <div className="hero-mockup">
                ...
                <div style={{ background: "linear-gradient(135deg,#0a1628,#0d2146)", padding: "28px 24px", color: "#fff", textAlign: "center" }}>
                  <div style={{ fontSize: "0.65rem", fontWeight: 700, color: "rgba(255,255,255,0.45)", textTransform: "uppercase", letterSpacing: 1.5, marginBottom: 10 }}>
                    Premium Barbershop
                  </div>
                ...
                <div style={{ padding: "14px 20px", background: "#fff", borderTop: "1px solid #f3f4f6" }}>
                  <div style={{ display: "flex", gap: 8 }}>
                    <button style={{ flex: 1, background: "#111827", color: "#fff", padding: "9px 10px", borderRadius: 9, border: "none", fontWeight: 700, fontSize: "0.72rem", cursor: "pointer" }}>
                      📅 Afspraak maken
                    </button>
                    <button style={{ flex: 1, background: "#25d366", color: "#fff", padding: "9px 10px", borderRadius: 9, border: "none", fontWeight: 700, fontSize: "0.72rem", cursor: "pointer" }}>
                      💬 WhatsApp
                    </button>
                  </div>
                </div>
